...
@section('content')
  ...
  <h1 class="titre-contact">Création du formulaire acteurs</h1>

  <!-- Début de mon formulaire -->
  <form action="{{route('actors.store')}}" method="post" class="form-horizontal" role="form">
   ...
   <!--<Groupe du Budget-->
             <div class="form-group" >
                 <label for="note" class="col-sm-2 control-label">Oscar</label>
                 <div class="col-sm-8">
